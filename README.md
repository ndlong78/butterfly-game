...
## UX hồ sơ & PIN trong canvas (PR #3)
- Bắt đầu chơi sẽ mở màn **Hồ sơ bé** ngay trên canvas (chọn tên preset + chỉnh tuổi bằng nút +/-).
- Vào báo cáo sẽ mở màn **PIN phụ huynh** với keypad số trên canvas (không dùng prompt của trình duyệt).
- Mục tiêu: trải nghiệm nhất quán, thân thiện mobile và không bị popup chặn.
